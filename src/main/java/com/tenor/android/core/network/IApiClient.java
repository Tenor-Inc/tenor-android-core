...
public interface IApiClient {
    ...
    Call<GifsResponse> search(@Query("key") @NonNull String apiKey,
                              ...
                              @Query("keyboardid") @NonNull String keyboardId,
    ...
    Call<TagsResponse> getTags(@Query("key") String apiKey,
                               ...
                               @Query("keyboardid") String keyboardId,
    ...
    Call<KeyboardIdResponse> getKeyboardId(@Query("key") String apiKey,
                                           @Query("locale") String locale);
    ...
    Call<Void> registerView(@Field("key") @NonNull String apiKey,
                            ...
                            @Field("keyboardid") String keyboardId,
